...
rec = database.get_all("2c0f:fe38:2021:bece:1:2:65:67f9")
...
# country = IP2Location.Country(r"D:\project_glamira\IP2Location-Python-master\data\country_test_ipv4_data.csv")
